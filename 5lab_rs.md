...
## Заходишь на localhost:8000 Счётчик hits в Redis увеличивается на 1

### По номеру посещения определяется сценарий:

Посещение	Условие	Что показывает
21, 42, 63...	делится на 21	Super Prize! 👑
10, 20, 30...	делится на 10	Milestone Visitor! 🎯
7, 14, 28...	делится на 7	Lucky Visitor! 🍀
2, 4, 6, 8...	чётное	Even Visitor ⚙️
1, 3, 5, 9...	остальное	Regular Visitor 👋
